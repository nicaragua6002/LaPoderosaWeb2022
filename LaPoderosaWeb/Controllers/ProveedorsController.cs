...
namespace LaPoderosaWeb.Controllers
{
    ...
    public class ProveedorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Telf,Contacto")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Telf,Contacto")] Proveedor proveedor)
        {
            if (ModelState.IsValid)
            {
